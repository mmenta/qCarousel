...
var qCarousel = {
    ...
    init: function(settings) {
        ...
        // set main carousel
        this.ui.carousel = $('#' + this.settings.elementId );
       
        // make call to endpoint
        var promise = $.get( 
                this.settings.endpoint, 
                { t: 'get_post_gallery', id: this.settings.category }
            );
    ...
    bindEventsGridView: function() {
        ...
        this.ui.gridView.find(this.ui.gridImg).on('click', function(e) {
            this.goToSlide(e);
        }.bind(this));
    },
    ...
    goToNext: function() {        
        this.ui.carousel.is(':visible') ?
            this.instance.single.next() : this.instance.grid.next();
    },
    
    goToPrev: function() {
        this.ui.carousel.is(':visible') ? 
            this.instance.single.prev() : this.instance.grid.prev();
    },
    ...
    updateInfo: function() {
        // get current slide
        var current = this.ui.carousel.find('div.active').index();
    ...
    buildGridView: function(gallery) {        
        ...
        for( var i = 0; i < gallery.items.length; ) { 
            for( var y = 0; y < this.settings.gridView; y++ ) {
        ...
        // output html
        this.ui.carousel.after(html);
        
        // set gridView element
        this.ui.gridView = $('#' + this.settings.elementId + '-grid'); 
